...
export const SERVICES: Service[] = [
  {
    ...
    shortName: 'Repair',
    icon: 'Wrench',
    shortDescription: '24/7 emergency AC repair services for all makes and models across our service areas.',
    longDescription: `When your air conditioner breaks down in extreme heat, every minute counts. Air Conditioning Champ provides fast, reliable AC repair services throughout Arizona, California, Nevada, and Texas. Our licensed technicians arrive with fully-stocked trucks to diagnose and repair most issues on the first visit.`,
    pricing: {
      min: 89,
      max: 500,
      unit: 'service call',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'We offer same-day emergency AC repair with typical response times of 1-2 hours. Our technicians are available 24/7, including nights, weekends, and holidays across all our service areas.',
      },
      {
      ...
      {
        question: 'What is the most common AC problem in hot climates?',
        answer: 'The most common AC issues in hot climates are capacitor failures, refrigerant leaks, and compressor problems—all caused by the extreme heat. Regular maintenance can prevent 80% of these issues.',
      },
      {
    ...
    metaTitle: 'AC Repair Services | 24/7 Emergency Service | Air Conditioning Champ',
    metaDescription: 'Fast, reliable AC repair services. Same-day service, all makes and models, upfront pricing. Call now for 24/7 emergency AC repair across Arizona, California, Nevada, and Texas.',
    keyTakeaways: [
      'Same-day AC repair available with 1-2 hour response times across all service areas',
  ...
  },
  {
    ...
    faqs: [
      {
        ...
        answer: 'A new AC system typically costs between $4,500-$12,000 depending on system size, efficiency rating, and features. We offer free estimates and flexible financing options.',
      },
      {
        question: 'What size AC do I need for my home?',
        answer: 'AC size depends on your home\'s square footage, insulation, windows, and other factors. We perform Manual J load calculations to determine the exact size needed—typically 3-5 tons for most homes.',
      },
      {
        question: 'What SEER rating should I choose for hot climates?',
        answer: 'For hot climates, we recommend a minimum 16 SEER rating. Higher SEER systems (18-26) cost more upfront but save significantly on energy bills over time.',
      },
      {
        question: 'How long does AC installation take?',
        answer: 'Most AC installations take 1-2 days. A straightforward replacement can often be completed in one day, while installations requiring ductwork modifications may take longer.',
      },
      {
    ...
    metaTitle: 'AC Installation Services | New AC System | Air Conditioning Champ',
    metaDescription: 'Professional AC installation services. Free estimates, top brands, financing available. New AC systems from $4,500. Call for a free quote today.',
    keyTakeaways: [
    ...
    faqs: [
      {
        ...
        answer: 'We recommend AC maintenance twice per year—once in spring before cooling season and once in fall. Hot climates put extra stress on systems, making regular maintenance crucial.',
      },
      {
        question: 'What does AC maintenance include?',
        answer: 'Our AC maintenance includes coil cleaning, refrigerant check, electrical inspection, thermostat calibration, filter replacement, and a 24-point system inspection.',
      },
      {
        question: 'Can AC maintenance prevent breakdowns?',
      ...
      {
        question: 'Do you offer AC maintenance plans?',
      ...
      },
      {
        ...
        answer: 'Skipping maintenance in hot climates leads to higher energy bills, more frequent breakdowns, and shortened equipment life. We see AC systems fail 5-7 years earlier without regular maintenance.',
      },
    ],
    relatedServices: ['hvac-tune-up', 'ac-repair', 'ac-installation'],
    metaTitle: 'AC Maintenance Services | AC Tune-Up | Air Conditioning Champ',
    metaDescription: 'Professional AC maintenance services. Prevent breakdowns, lower bills, extend AC life. Tune-ups from $89. Call to schedule your maintenance today.',
    keyTakeaways: [
  ...
  },
  {
    ...
    shortName: 'Heating',
    icon: 'Flame',
    shortDescription: 'Expert furnace and heat pump repair services for your home.',
    longDescription: `When cold weather arrives, you need reliable heating. Air Conditioning Champ provides expert heating repair services including furnace repair, heat pump repair, and electric heater service. Our technicians diagnose and repair all heating systems quickly to restore your comfort.`,
    pricing: {
      min: 89,
      max: 450,
      unit: 'service call',
    ...
    faqs: [
      {
        question: 'Do you repair furnaces?',
        answer: 'Yes, we repair all types of furnaces including gas furnaces, electric furnaces, and dual-fuel systems. Our technicians are trained on all major brands.',
      },
      {
        question: 'How much does heating repair cost?',
        answer: 'Heating repair typically costs between $89-$450 depending on the issue. Our diagnostic fee is $89 and is waived if you proceed with the repair.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Yes, we service and repair all types of heat pumps. Heat pumps are popular because they provide both heating and cooling efficiently.',
      },
      {
        question: 'When should I call for emergency heating repair?',
        answer: 'Call for emergency heating repair if you smell gas, hear unusual noises, or have no heat during cold weather. We offer 24/7 emergency heating service.',
      },
    ],
    relatedServices: ['ac-repair', 'hvac-tune-up', 'emergency-service'],
    metaTitle: 'Heating Repair Services | Furnace Repair | Air Conditioning Champ',
    metaDescription: 'Expert heating and furnace repair services. Same-day service, all brands, upfront pricing. Call for fast heating repair today.',
    keyTakeaways: [
  ...
  },
  {
    ...
    longDescription: `Keep your entire HVAC system running at peak performance with a comprehensive tune-up from Air Conditioning Champ. Our tune-up service covers both your cooling and heating systems, ensuring year-round comfort in your home. We inspect, clean, and adjust all components for optimal efficiency.`,
    pricing: {
      min: 129,
      max: 199,
    ...
    faqs: [
      ...
      {
        question: 'How often should I get an HVAC tune-up?',
        answer: 'We recommend a complete HVAC tune-up at least once per year, ideally in spring before the intense cooling season begins.',
      },
      {
        question: 'Can a tune-up improve my HVAC efficiency?',
      ...
      },
      {
        ...
        answer: 'A complete HVAC tune-up costs $129-$199 and covers both your cooling and heating systems. This is a great value compared to separate services.',
      },
      {
    ...
    metaTitle: 'HVAC Tune-Up Services | AC & Heating Service | Air Conditioning Champ',
    metaDescription: 'Complete HVAC tune-up services. AC and heating inspection, cleaning, and service from $129. Improve efficiency and prevent breakdowns.',
    keyTakeaways: [
  ...
  },
  {
    ...
    faqs: [
      {
        ...
        answer: 'No, we do not charge overtime or extra fees for nights, weekends, or holidays. Our emergency rates are the same as our regular rates.',
      },
      {
        question: 'How fast can you respond to an HVAC emergency?',
        answer: 'Our typical response time for HVAC emergencies is 1-2 hours. We prioritize emergencies and dispatch the nearest available technician.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Yes, we provide 24/7 emergency service 365 days a year, including all holidays. HVAC emergencies happen any day, and we\'re always ready.',
      },
      {
    ...
    metaTitle: '24/7 Emergency HVAC Service | Air Conditioning Champ',
    metaDescription: '24/7 emergency AC and heating repair services. No overtime charges, 1-2 hour response. Call now for emergency HVAC service.',
    keyTakeaways: [
      '24/7 emergency HVAC service with no overtime or after-hours charges',
      '1-2 hour average response time across all service areas',
